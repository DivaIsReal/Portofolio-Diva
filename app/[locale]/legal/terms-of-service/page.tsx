...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Diva Ahmad Pradana's Portfolio App regarding TikTok API usage",
    ...
    <Container data-aos="fade-up">
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            This website is a personal portfolio created to showcase Diva
            Ahmad Pradana&apos;s professional projects, technical skills, and social
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            the property of Diva Ahmad Pradana. Content displayed through the TikTok
