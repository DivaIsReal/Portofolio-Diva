export const UMAMI_ACCOUNT = {
  ...
  websites: [
    {
      domain: "divaisreal.my.id",
      website_id: process.env.UMAMI_WEBSITE_ID_MYID,
      umami_url: process.env.UMAMI_SHARE_URL_MYID ?? "#",
    },
    {
      domain: "divaisreal.site",
      website_id: process.env.UMAMI_WEBSITE_ID_SITE,
      umami_url: process.env.UMAMI_SHARE_URL_SITE ?? "#",
    },
  ],
};
